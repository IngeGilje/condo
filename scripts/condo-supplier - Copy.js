...
async function updateSuppliersRow(supplierId) {
  ...
  const validCity = validateText('city', columnWidths, '', 'Ugyldig poststed', true, city, 0, 45, '',);
  ...
  const validText = validateText('text', columnWidths, '', 'Ugyldig tekst', true, text, 0, 45);
