...
if ((objBankAccount.condominiumId === 0) || (objBankAccount.user === null)) {
  ...
  async function main() {
    ...
    if (await objUser.checkServer()) {
      ...
      objBankAccount.objBankAccount.showMessageNew(columnWidths, '', 'Server er ikke startet.');
    }
  }
}
...
function showBankAccounts(menuNumber, bankAccountId) {
  ...
  // Table header (<tr></tr>)
  menuNumber++;
  html += objBankAccount.showTableHeaderMenu(menuNumber, objBankAccount.accountMenu, '','center', 'Navn', 'Bankkontonummer');
  ...
  html += objBankAccount.editTableCell('name', name, 45, enableChanges);
  ...
  html += objBankAccount.editTableCell('bankAccount', bankAccount, 11, enableChanges);
  html += "</tr>";

  // Show menu
  menuNumber++;
  html += objBankAccount.showTableHeaderMenu(menuNumber, objBankAccount.accountMenu, '', 'center', 'Dato', 'Inngående saldo');
  ...
  html += objBankAccount.editTableCell('openingBalanceDate',  openingBalanceDate, 10, enableChanges);
  ...
  html += objBankAccount.editTableCell('openingBalance', openingBalance, 11, enableChanges);
  html += "</tr>";

  // Show menu
  // Header for value 
  menuNumber++;
  html += objBankAccount.showTableHeaderMenu(menuNumber, objBankAccount.accountMenu, '', 'center','Dato', 'Utgående saldo');
  ...
  html += objBankAccount.editTableCell('closingBalanceDate',  closingBalanceDate, 10, enableChanges);
...
function showFilter(menuNumber, condominiumId) {
  ...
  // Header filter (<tr></tr>)
  menuNumber++;
  html += objBankAccount.showTableHeaderMenu(menuNumber, objBankAccount.accountMenu, '','center', 'Sameie', 'Bankkonto');
