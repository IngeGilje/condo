...
const disableChanges = (objBankAccountTransaction.securityLevel < 5);
const condominiumId = objBankAccountTransaction.condominiumId;
const user = objBankAccountTransaction.user;
