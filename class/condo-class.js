...
function connectingToServer() {
  ...
  switch (objUser.serverStatus) {
    ...
    case 1: {
      ...
      // Always use relative URL so it works on ingegilje.no
      //socket = 
      //  new WebSocket("wss://" + window.location.host + ":3000/ws");
      socket =
        "ws://localhost:8080/ws"

      /*
      socket.onopen = () => {
        console.log("✅ Connected to Node.js WebSocket through IIS");
